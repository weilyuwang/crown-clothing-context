...
Replace the local state management from redux to the new context API. This repository is the crown clothing application before Redux Saga is used to handle the asynchronous code.
